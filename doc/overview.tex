...
\paragraph{Cyber-Physical Systems:} The Internet of Things requires massively scalable solutions to Machine-to-Machine
communication and data synchronization. \emph{liblim} is ideally suited to these kinds of applications due to its strong
tolerance to unstable network conditions and guaranteed eventual convergence.

\paragraph{Collaborative document editing:} Though this one seems to have attracted quite some attention in the past, we
consider it sub-par revolutionary and it seems collarborative editing schemes often have a certain smell to their code
bases.
